...
public class QrServiceProbeLite {
    public static void main(String[] args) throws Exception {
        ...
        Resource[] mappers = new Resource[] {
            resolver.getResource("file:C:/study/LocalQuest/Backend/src/main/webapp/WEB-INF/mybatis/mapper/business/business_mapper.xml"),
            resolver.getResource("file:C:/study/LocalQuest/Backend/src/main/webapp/WEB-INF/mybatis/mapper/location/location_mapper.xml"),
            resolver.getResource("file:C:/study/LocalQuest/Backend/src/main/webapp/WEB-INF/mybatis/mapper/locationqr/locationqr_mapper.xml")
        };
