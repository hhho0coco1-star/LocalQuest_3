...
<div class="adm-b-container">
    <div class="adm-b-header">
        <div class="adm-b-title-wrap">
            <h2 class="adm-b-title"><i class="fas fa-map-marked-alt"></i> 비즈니스 관리</h2>
            ...
            <table class="adm-b-table">
                ...
                <tbody>
                    <c:choose>
                                ...
                                <tr class="adm-b-row">
                                    ...
                                    <td>
                                        <div class="adm-b-actions">
                                            ...
                                            <button type="button" class="adm-b-btn-delete" onclick="deleteBusiness(${business.businessId})">삭제</button>
                                        </div>
                                    </td>
                                </tr>
                            </c:forEach>
                        ...
                        <c:otherwise>
                            <tr><td colspan="7" class="adm-b-empty">등록된 매장 데이터가 없습니다.</td></tr>
                        </c:otherwise>
                    </c:choose>
                </tbody>
            </table>
